#ifndef	_HEAD_FIRST_DESIGN_PATTERNS_CHAIN_OF_RESPONSIBILITY_NEW_LOCATION_HANDLER_HPP_
#define _HEAD_FIRST_DESIGN_PATTERNS_CHAIN_OF_RESPONSIBILITY_NEW_LOCATION_HANDLER_HPP_
...
class NewLocationHandler : public Handler {
	public: explicit NewLocationHandler(const Handler* successor = 0) : Handler(successor) {
	}
