#ifndef	_HEAD_FIRST_DESIGN_PATTERNS_CHAIN_OF_RESPONSIBILITY_FAN_HANDLER_HPP_
#define _HEAD_FIRST_DESIGN_PATTERNS_CHAIN_OF_RESPONSIBILITY_FAN_HANDLER_HPP_
...
class FanHandler : public Handler {
	public: explicit FanHandler(const Handler* successor = 0) : Handler(successor) {
	}
